...
module.exports = {
  askConfiguration: (initialData) => {
    const inputLanguages = language.languages;
    const outputLanguages = language.languages;
    ...
    const questions = [
      ...
      ... initialData.outputLanguage ? [] : [{
        ...
        validate: function(value, data) {
            ...
            if (outputLanguages.includes(value) && value !== data.inputLanguage) {
                return true;
            } else {
                return 'Please enter a valid language.';
            }
